...
class TestEventCard:
    ...
    def test_opening_hours_3_days(self):
        """Test opening hours over 3 days."""
        mock_event = SimpleNamespace(
            start_date=arrow.get("2024-01-15 09:00:00"),
            end_date=arrow.get("2024-01-17 20:00:00"),
            owner=SimpleNamespace(),
        )
    ...
    def test_attrs_post_init_sets_opening(self):
        ...
        with patch(
            ...
            assert mock_event.__dict__["opening"] == "De 14:00 à 16:00 le 15 jan 2024"
