...
"""Unit tests for `taille_orga_label` in
`app.modules.swork.components.members_list`.

`taille_orga_label` maps a `taille_orga` ontology code to its
...
from app.modules.swork.components.taille_orga import taille_orga_label
...
class TestTailleOrgaLabel:
    ...
    def test_zero_treated_as_numeric(self):
        ...
        assert taille_orga_label("0") == "JusquՈ 0"
    ...
    def test_negative_numeric(self):
        ...
        assert taille_orga_label("-1") == "JusquՈ -1"
    ...
    def test_decimal_string_returns_raw(self):
        ...
        output shape."""
        assert taille_orga_label("3.14") == "3.14"
    ...
    def test_returns_string(self):
        ...
        for value in ("+", "1", "10", "bogus", ""):
            result = taille_orga_label(value)
    ...
    def test_two_specific_codes_are_distinguishable(self):
        ...
        assert taille_orga_label("+") != taille_orga_label("1")
        # And neither equals the numeric-branch output for the
        # underlying number.
        assert taille_orga_label("1") != taille_orga_label("2")
