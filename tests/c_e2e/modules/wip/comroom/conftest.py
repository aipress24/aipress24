...
"""Override WIP fixtures for comroom tests.

Comroom requires PRESS_RELATIONS (or EXPERT/TRANSFORMER/ACADEMIC) instead of
PRESS_MEDIA. This conftest overrides test_user so all comroom tests get a user
with correct role.
"""
