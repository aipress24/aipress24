...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['avis_enquete_id'], ['nrm_avis_enquete.id'], ondelete='CASCADE'),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['notification_id'], ['nrm_notification_publication.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['contact_id'], ['nrm_contact_avis_enquete.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id'),
    )
