...
def wizard_page(profile_id: str):
    ...
    if modify_form and request.method == "GET":
        ...
        # validating.
        # `SessionService.get` raises without an explicit default, and on a
        # fresh session there is nothing stored yet — this leg runs for a
        # first-time sign-up as well as for a member editing their profile.
