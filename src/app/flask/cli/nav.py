...
def _create_mock_user_with_roles(role_names: list[str]) -> object:
    ...
    for role_name in role_names:
        ...
        try:
            ...
            valid_roles = ", ".join(r.name for r in RoleEnum)  # type: ignore[attr-defined]  # ty:ignore[not-iterable]
...
def roles() -> None:
    ...
    for node in nav_tree._nodes.values():
        ...
        if not effective:
            ...
            for role in RoleEnum:  # type: ignore[attr-defined]  # ty:ignore[not-iterable]
