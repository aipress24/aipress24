...
class Organisation(IdMixin, LifeCycleMixin, Addressable, Base):
    ...
    metiers: Mapped[dict] = mapped_column(JSON, default="[]")
    metiers_detail: Mapped[dict] = mapped_column(JSON, default="[]")
    ...
    secteurs_activite: Mapped[dict] = mapped_column(JSON, default="[]")
    secteurs_activite_detail: Mapped[dict] = mapped_column(JSON, default="[]")
    secteurs_activite_couverts: Mapped[dict] = mapped_column(JSON, default="[]")
    secteurs_activite_couverts_detail: Mapped[dict] = mapped_column(JSON, default="[]")
    type_organisation: Mapped[dict] = mapped_column(JSON, default="[]")
    type_organisation_detail: Mapped[dict] = mapped_column(JSON, default="[]")
    ...
    metiers_presse: Mapped[dict] = mapped_column(JSON, default="[]")
    type_entreprise_media: Mapped[dict] = mapped_column(JSON, default="[]")
